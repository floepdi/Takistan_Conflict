...
if(playersNumber west < 10) exitWith { hint "Es sind nicht genügend ARMY's im Dienst."};
if(isNull _building) exitWith {};
if(!(_building isKindOf "House_F")) exitWith {hint "You are not looking at a house door."};
if(isNil "life_boltcutter_uses") then {life_boltcutter_uses = 0;};
if(!((nearestObject [[1552.1,11980.5,0],"Land_Dome_Big_F"]) == _building OR (nearestObject [[16019.5,16952.9,0],"Land_Research_house_V1_F"]) == _building)) exitWith {};
