...
//if(typeOf _vault != "Land_Cargo20_military_green_F") exitWith {hint localize "STR_ISTR_Blast_VaultOnly"};
...
_bomb = "Missile_AA_03_F" createVehicle [getPosATL fed_bank select 0, getPosATL fed_bank select 1, (getPosATL fed_bank select 2)+0.5];
