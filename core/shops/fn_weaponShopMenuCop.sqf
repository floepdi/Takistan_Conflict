...
uiNamespace setVariable ["Weapon_Shop_Cop",_this select 3];

disableSerialization;
if(!(createDialog "life_weapon_shop_cop")) exitwith {};

_config = [_this select 3] call life_fnc_weaponShopCopCfg;
